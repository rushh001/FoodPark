...
import com.example.foodpark.databinding.FragmentNorthTrendBinding;
import com.example.foodpark.databinding.FragmentTrendingBinding;

import java.util.ArrayList;


public class NorthTrendFragment extends Fragment implements buttonClickListner{
    FragmentNorthTrendBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentNorthTrendBinding.inflate(inflater, container, false);
    ...
    private void setUpMenu() {
        String dishes_names[] = getResources().getStringArray(R.array.northtrenddish);
        ...
        String dish_ids[] = getResources().getStringArray(R.array.northtrendids);
